...
def salva_simulazione():
    try:
        ...
        if dati:
            # Caso A: Il file HTML sta usando Javascript per inviare i dati
            risposte_utente = dati.get('risposte', {})
        else:
            # Caso B: Il file HTML sta usando un normale form
            # Convertiamo i dati del form in un dizionario compatibile
